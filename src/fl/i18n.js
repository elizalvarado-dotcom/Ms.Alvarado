...
export const T = {
  en: {
    ...
    quizCompleteSub: pct => `You scored ${pct}%. Great work!`,
    retakeQuiz: 'Retake Quiz',
    pointsEarned: (earned, max) => `${earned}/${max} points`,
    attemptsLabel: n => `${n} attempt${n === 1 ? '' : 's'}`,
    breakdownLabel: 'Question Breakdown',
    downloadPdf: '⬇ Download PDF Report',
    reportTitle: 'Understanding Check — Summary Report',
  ...
  es: {
    ...
    quizCompleteSub: pct => `Obtuviste ${pct}%. ¡Buen trabajo!`,
    retakeQuiz: 'Repetir Cuestionario',
    pointsEarned: (earned, max) => `${earned}/${max} puntos`,
    attemptsLabel: n => `${n} intento${n === 1 ? '' : 's'}`,
    breakdownLabel: 'Desglose de Preguntas',
    downloadPdf: '⬇ Descargar Informe en PDF',
    reportTitle: 'Comprobación de Comprensión — Informe Resumen',
